...
const ReportForm: React.FC = () => {
  ...
  const companyOptions = createOptions(mockCompanies, "id", (c) => c.name);
  ...
  const areRequiredFieldsFilled =
    ...
    (selectedOperation?.name === "Перемещение" || formData.wallet);
    ...
    >
      ...
      {areRequiredFieldsFilled && (
        <Button
          ...
          onClick={() => alert("Кнопка Посмотреть счет нажата!")} 
        >
          Посмотреть счет
        </Button>
      )}
